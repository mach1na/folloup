(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const Nt={mode:"absolute",position:"bottom",height:"6rem",strength:2,divCount:5,exponential:!1,opacity:1,curve:"linear",zIndex:2},ot={linear:t=>t,bezier:t=>t*t*(3-2*t),"ease-in":t=>t*t,"ease-out":t=>1-Math.pow(1-t,2),"ease-in-out":t=>t<.5?2*t*t:1-Math.pow(-2*t+2,2)/2};function Vt(t){switch(t){case"top":return"to top";case"left":return"to left";case"right":return"to right";default:return"to bottom"}}function Dt(){if(typeof CSS>"u"||typeof CSS.supports!="function")return!1;const t=CSS.supports("backdrop-filter","blur(1px)")||CSS.supports("-webkit-backdrop-filter","blur(1px)"),e=CSS.supports("mask-image","linear-gradient(to bottom, transparent, black)")||CSS.supports("-webkit-mask-image","linear-gradient(to bottom, transparent, black)");return t&&e}function Ht(t){const e={...Nt,...t},n=document.createElement("div"),o=document.createElement("div"),i=Vt(e.position),a=Dt(),l=e.position==="top"||e.position==="bottom";if(n.className="gradual-blur",e.className&&n.classList.add(e.className),a||(n.classList.add("gradual-blur--fallback"),n.style.background=`linear-gradient(${i}, transparent 0%, ${e.fallbackColor||"rgba(255, 255, 255, 0.95)"} 100%)`),n.style.position=e.mode,n.style.pointerEvents="none",n.style.zIndex=String(e.zIndex),n.style.opacity="0",n.style.borderRadius="inherit",l?(n.style.height=e.height,n.style.width=e.width||"100%",n.style[e.position]="0",e.mode==="fixed"?(n.style.left="50%",n.style.right="auto",n.style.transform="translateX(-50%)"):(n.style.left="0",n.style.right="0")):(n.style.width=e.width||e.height,n.style.height="100%",n.style.top="0",n.style.bottom="0",n.style[e.position]="0"),o.className="gradual-blur__inner",n.appendChild(o),a){const c=100/e.divCount,d=ot[e.curve]||ot.linear;for(let f=1;f<=e.divCount;f+=1){const p=document.createElement("div"),k=d(f/e.divCount);let S=0;e.exponential?S=Math.pow(2,k*4)*.0625*e.strength:S=.0625*(k*e.divCount+1)*e.strength;const v=Math.round((c*f-c)*10)/10,y=Math.round(c*f*10)/10,T=Math.round((c*f+c)*10)/10,E=Math.round((c*f+c*2)*10)/10;let s=`transparent ${v}%, black ${y}%`;T<=100&&(s+=`, black ${T}%`),E<=100&&(s+=`, transparent ${E}%`),p.className="gradual-blur__layer",p.style.maskImage=`linear-gradient(${i}, ${s})`,p.style.webkitMaskImage=`linear-gradient(${i}, ${s})`,p.style.backdropFilter=`blur(${S.toFixed(3)}rem)`,p.style.setProperty("-webkit-backdrop-filter",`blur(${S.toFixed(3)}rem)`),p.style.opacity=String(e.opacity),o.appendChild(p)}}return window.getComputedStyle(e.mount).position==="static"&&(e.mount.style.position="relative"),e.mount.appendChild(n),{element:n,setVisible(c){n.style.opacity=c?"1":"0"},destroy(){n.remove()}}}const $t=`:host {
  display: inline-flex;
  align-items: center;
...
`,Kt=document.createElement("template");Kt.innerHTML=`
  <style>${$t}</style>
  <span class="badge">
    <slot></slot>
  </span>
...
`;function rt(t){return t==="submit"||t==="reset"?t:"button"}class Rt extends HTMLElement{static get observedAttributes(){return["disabled","aria-label","type"]}constructor(){super();const e=this.attachShadow({mode:"open",delegatesFocus:!0});e.append(ft.content.cloneNode(!0)),this.button=e.querySelector("button")}connectedCallback(){this.dataset.component=F,this.syncAttributes()}attributeChangedCallback(){this.syncAttributes()}get disabled(){return this.hasAttribute("disabled")}set disabled(e){this.toggleAttribute("disabled",e)}get type(){return rt(this.getAttribute("type"))}set type(e){this.setAttribute("type",rt(e))}focus(e){this.button.focus(e)}click(){this.button.click()}syncAttributes(){this.button.disabled=this.disabled,this.button.type=this.type,this.tabIndex=this.disabled?-1:0;const e=this.getAttribute("aria-label");e?this.button.setAttribute("aria-label",e):this.button.removeAttribute("aria-label")}}function Gt(){customElements.get(F)||customElements.define(F,Rt)}const Zt=`:host {
  display: contents;
}
...
`,R="ui-bottom-sheet",mt=document.createElement("template"),Ut=["a[href]","button:not([disabled])","details summary","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(", ");let H=0;mt.innerHTML=`
  <style>${Zt}</style>
...
`;function at(t){return t==="submit"||t==="reset"?t:"button"}class se extends HTMLElement{static get observedAttributes(){return["disabled","aria-label","type"]}constructor(){super();const e=this.attachShadow({mode:"open",delegatesFocus:!0});e.append(bt.content.cloneNode(!0)),this.button=e.querySelector("button")}connectedCallback(){this.dataset.component=Z,this.syncAttributes()}attributeChangedCallback(){this.syncAttributes()}get disabled(){return this.hasAttribute("disabled")}set disabled(e){this.toggleAttribute("disabled",e)}get type(){return at(this.getAttribute("type"))}set type(e){this.setAttribute("type",at(e))}focus(e){this.button.focus(e)}click(){this.button.click()}syncAttributes(){this.button.disabled=this.disabled,this.button.type=this.type,this.tabIndex=this.disabled?-1:0;const e=this.getAttribute("aria-label");e?this.button.setAttribute("aria-label",e):this.button.removeAttribute("aria-label")}}function ae(){customElements.get(Z)||customElements.define(Z,se)}const le='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="m644-428-58-58q9-47-27-88t-93-32l-58-58q17-8 34.5-12t37.5-4q75 0 127.5 52.5T660-500q0 20-4 37.5T644-428Zm128 126-58-56q38-29 67.5-63.5T832-500q-50-101-143.5-160.5T480-720q-29 0-57 4t-55 12l-62-62q41-17 84-25.5t90-8.5q151 0 269 83.5T920-500q-23 59-60.5 109.5T772-302Zm20 246L624-222q-35 11-70.5 16.5T480-200q-151 0-269-83.5T40-500q21-53 53-98.5t73-81.5L56-792l56-56 736 736-56 56ZM222-624q-29 26-53 57t-41 67q50 101 143.5 160.5T480-280q20 0 39-2.5t39-5.5l-36-38q-11 3-21 4.5t-21 1.5q-75 0-127.5-52.5T300-500q0-11 1.5-21t4.5-21l-84-82Zm319 93Zm-151 75Z"/></svg>',ce='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z"/></svg>',de=`:host {
  display: block;
  width: 100%;
}
...
`,j="ui-network-status",Ct="actionBtn",xt="settingsBtn",St="wifiStatusLabel",Tt="wifiStatusIcon",kt="wifiStatusNetwork",At=document.createElement("template");At.innerHTML=`
  <style>${ye}</style>
  <div class="wifi-status-card">
    <div class="wifi-status-card__content">
      <div class="wifi-status-card__status">
        <span class="card-icon" id="${Tt}"></span>
        <span id="${St}" class="wifi-status-card__label">
          Disconnected
        </span>
        <span
          id="${kt}"
...
`;function we(t,e){return t.includes("class=")?t.replace("<svg",`<svg class="${e}"`):t.replace("<svg",`<svg class="${e}"`)}class Ce extends HTMLElement{static get observedAttributes(){return["action-label","network","status-label"]}constructor(){super();const e=this.attachShadow({mode:"open"});e.append(At.content.cloneNode(!0)),this.actionButton=e.querySelector(`#${Ct}`),this.actionButton.addEventListener("click",n=>{n.stopPropagation(),this.dispatchEvent(new Event("action",{bubbles:!0,composed:!0}))}),this.iconElement=e.querySelector(`#${Tt}`),this.labelElement=e.querySelector(`#${St}`),this.networkElement=e.querySelector(`#${kt}`),this.settingsButton=e.querySelector(`#${xt}`),this.settingsButton.addEventListener("click",n=>{n.stopPropagation(),this.dispatchEvent(new Event("settings",{bubbles:!0,composed:!0}))})}connectedCallback(){this.dataset.component=j,this.syncAttributes()}attributeChangedCallback(){this.syncAttributes()}get actionDisabled(){return!!this.actionButton.disabled}set actionDisabled(e){this.actionButton.disabled=e}get iconSvg(){return this.iconElement.innerHTML}set iconSvg(e){this.iconElement.innerHTML=e?we(e,"wifi-icon"):""}get network(){return this.getAttribute("network")||""}set network(e){this.setAttribute("network",e)}get actionLabel(){return this.getAttribute("action-label")||"Connect"}set actionLabel(e){this.setAttribute("action-label",e)}get statusLabel(){return this.getAttribute("status-label")||"Disconnected"}set statusLabel(e){this.setAttribute("status-label",e)}syncAttributes(){this.actionButton.textContent=this.actionLabel,this.actionButton.setAttribute("aria-label",this.actionLabel),this.labelElement.textContent=this.statusLabel,this.networkElement.textContent=this.network,this.networkElement.hidden=this.network.length===0}}function xe(){customElements.get(j)||customElements.define(j,Ce)}const Se=`:host {
  display: block;
  width: 100%;
}
...
`,Oe='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="m109-531-85-85q92-89 210-136.5T480-800q128 0 246 47.5T936-616l-85 85q-75-72-171-110.5T480-680q-104 0-200 38.5T109-531Zm169 169-84-84q59-55 132.5-84.5T480-560q80 0 153.5 29.5T766-446l-84 84q-42-38-93.5-58T480-440q-57 0-108.5 20T278-362Zm202 202q-33 0-56.5-23.5T400-240q0-33 23.5-56.5T480-320q33 0 56.5 23.5T560-240q0 33-23.5 56.5T480-160Z"/></svg>',Ne='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M240-80q-33 0-56.5-23.5T160-160v-400q0-33 23.5-56.5T240-640h40v-80q0-83 58.5-141.5T480-920q83 0 141.5 58.5T680-720v80h40q33 0 56.5 23.5T800-560v400q0 33-23.5 56.5T720-80H240Zm0-80h480v-400H240v400Zm240-120q33 0 56.5-23.5T560-360q0-33-23.5-56.5T480-440q-33 0-56.5 23.5T400-360q0 33 23.5 56.5T480-280ZM360-640h240v-80q0-50-35-85t-85-35q-50 0-85 35t-35 85v80ZM240-160v-400 400Z"/></svg>',Ve='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-600q96-98 220-149t260-51q137 0 261 51t219 149L480-120ZM361-353q25-18 55.5-28t63.5-10q33 0 63.5 10t55.5 28l245-245q-78-59-170.5-90.5T480-720q-101 0-193.5 31.5T116-598l245 245Z"/></svg>',De='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-600q96-98 220-149t260-51q137 0 261 51t219 149L480-120ZM299-415q38-28 84-43.5t97-15.5q51 0 97 15.5t84 43.5l183-183q-78-59-170.5-90.5T480-720q-101 0-193.5 31.5T116-598l183 183Z"/></svg>',He='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-600q96-98 220-149t260-51q137 0 261 51t219 149L480-120ZM232-482q53-38 116-59.5T480-563q69 0 132 21.5T728-482l116-116q-78-59-170.5-90.5T480-720q-101 0-193.5 31.5T116-598l116 116Z"/></svg>',$e='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-600q95-97 219.5-148.5T480-800q136 0 260.5 51.5T960-600L480-120Z"/></svg>',Ke='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-601q93-93 215.5-146T480-800q142 0 264.5 53T960-601l-56 57q-81-81-190-128.5T480-720q-103 0-195 32.5T117-597l419 420-56 57Zm384-40L761-262q-18 11-38 16.5t-43 5.5q-68 0-114-46t-46-114q0-68 46-114t114-46q68 0 114 46t46 114q0 23-5.5 43T818-319l102 103-56 56ZM680-320q34 0 57-23t23-57q0-34-23-57t-57-23q-34 0-57 23t-23 57q0 34 23 57t57 23ZM480-177Z"/></svg>',Fe='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M280-240q-100 0-170-70T40-480q0-100 70-170t170-70q66 0 121 33t87 87h432v240h-80v120H600v-120H488q-32 54-87 87t-121 33Zm0-80q66 0 106-40.5t48-79.5h246v120h80v-120h80v-80H434q-8-39-48-79.5T280-640q-66 0-113 47t-47 113q0 66 47 113t113 47Zm0-80q33 0 56.5-23.5T360-480q0-33-23.5-56.5T280-560q-33 0-56.5 23.5T200-480q0 33 23.5 56.5T280-400Zm0-80Z"/></svg>',Re='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg>',Ge='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>',Ze={"Content-Type":"application/json",Accept:"application/json"},ct=64,Ue=2e3,We=8,Je=2e3,je=8,Ye=3e3,Xe=750,Qe=20,tn="/api/settings",en=`${tn}/time`,nn="/api/runtime/time",on=1e4;async function B(t,e){const n=new AbortController,o=setTimeout(()=>n.abort(),on);let i;try{i=await fetch(t,{cache:"no-store",...e,signal:e?.signal??n.signal,headers:{...Ze,...e?.headers||{}}})}catch(d){throw n.signal.aborted?new Error(`Request to ${t} timed out. Check the device is still reachable.`):d}finally{clearTimeout(o)}const a=i.headers.get("content-type")||"",l=await i.text();if(!a.includes("application/json"))throw new Error(`Unexpected response for ${t}. Make sure you are connected to the device AP and loading the portal from the ESP32.`);const c=JSON.parse(l);if(!i.ok||c.success!==!0)throw new Error(c.message||"Request failed.");return c}const rn=(t,e)=>B(t,e),sn=(t,e)=>B(t,e),an=(t,e)=>B(t,e),Lt=(t,e)=>B(t,e),ln=(t,e)=>B(t,e);function b(t){const e=document.getElementById(t);if(!e)throw new Error(`Required portal element "#${t}" was not found.`);return e}function cn(){return{followupLogoEl:b("followupLogo"),wifiStatusCard:b("wifiStatusCard"),wifiSettingsSheet:b("wifiSettingsSheet"),wifiSettingsCloseBtn:b("wifiSettingsCloseBtn"),wifiSettingsNotification:b("wifiSettingsNotification"),networkList:b("networkList"),passwordInput:b("password"),scanBtn:b("scanBtn"),connectBtn:b("connectBtn"),geminiCard:b("geminiCard"),geminiApiKeyInput:b("geminiApiKeyInput"),geminiClearBtn:b("geminiClearBtn"),geminiSaveBtn:b("geminiSaveBtn"),timezoneLocationCard:b("timezoneLocationCard"),timezoneSelect:b("timezoneSelect"),manualTimeInput:b("manualTimeInput"),manualDateInput:b("manualDateInput"),timezoneLocationClearBtn:b("timezoneLocationClearBtn"),timezoneLocationSaveBtn:b("timezoneLocationSaveBtn")}}function It(t){return(e,n="info")=>{t.setNotification(e,n)}}function dn(t){return(e,n="info")=>{if(!e){t.hidden=!0,t.textContent="",t.removeAttribute("data-status"),t.setAttribute("role","status"),t.setAttribute("aria-live","polite");return}t.hidden=!1,t.textContent=e,t.setAttribute("data-status",n),n==="error"||n==="danger"?(t.setAttribute("role","alert"),t.setAttribute("aria-live","assertive")):n==="warning"?(t.setAttribute("role","alert"),t.setAttribute("aria-live","polite")):(t.setAttribute("role","status"),t.setAttribute("aria-live","polite"))}}function tt(t){t.classList.remove("error"),t.removeAttribute("invalid"),t.setAttribute("aria-invalid","false"),t.setCustomValidity?.("")}function et(t,e){t.classList.add("error"),t.setAttribute("invalid",""),t.setAttribute("aria-invalid","true"),t.setCustomValidity?.(e)}function un(t,e){t.setAttribute("aria-checked",e?"true":"false")}function hn(t){return t.getAttribute("aria-checked")==="true"}function Mt(t,e){return t.includes("class=")?t.replace("<svg",`<svg class="${e}"`):t.replace("<svg",`<svg class="${e}"`)}function gn(t,e,n){t.innerHTML=Mt(e,n)}function fn(t){return new Promise(e=>{setTimeout(e,t)})}function mn(){const t=document.documentElement.lang?.trim();return t||"en-US"}function pn(t){try{return new Intl.DateTimeFormat(mn(),{hour:"numeric",timeZone:t,timeZoneName:"longGeneric"}).formatToParts(new Date).find(o=>o.type==="timeZoneName")?.value?.trim()||""}catch(e){return console.warn(`Failed to format timezone label for "${t}".`,e),""}}function dt(t){return/^(GMT|UTC)(?:[+-]\d{1,2}(?::\d{2})?)?$/.test(t)}function bn(t){return(t.split("/").pop()||t).replace(/_/g," ")}function Bt(t){return t.split("/").map(e=>e.replace(/_/g," ")).join(" / ")}function vn(t){const e=t.map(i=>{const a=pn(i.name);return{cityLabel:bn(i.name),genericLabel:a,name:i.name}}),n=new Map(e.map(i=>[i.name,i])),o=new Map;return e.forEach(i=>{!i.genericLabel||dt(i.genericLabel)||o.set(i.genericLabel,(o.get(i.genericLabel)||0)+1)}),new Map(t.map(i=>{const a=n.get(i.name),l=i.description?.trim()||"";if(a?.genericLabel&&!dt(a.genericLabel)){const d=(o.get(a.genericLabel)||0)>1?`${a.genericLabel} (${a.cityLabel})`:a.genericLabel;return[i.name,d]}return l?[i.name,l]:[i.name,Bt(i.name)]}))}function yn(t,e){return e.get(t.name)||t.description?.trim()||Bt(t.name)}function wn(t){const e=t.value.trim();if(!e)return null;const n=/^(\d{2}):(\d{2})$/.exec(e);if(!n)return null;const o=Number.parseInt(n[1],10),i=Number.parseInt(n[2],10);return!Number.isFinite(o)||!Number.isFinite(i)||o<0||o>23||i<0||i>59?null:o*60+i}function P(t,e,n){t.hasKey=n?.has_key===!0,t.last4=typeof n?.last4=="string"?n.last4:"",e.value=t.hasKey?t.last4?`******${t.last4}`:"******":""}function ut(t,e,n){t.hasKey=!1,t.last4="",e.value="",n("")}async function ht(t,e,n,o,i,a,l){const c=e.value.trim();if(!c){n(`${l} is required.`,"warning");return}t.isBusy=!0,n(a,"info"),o();try{const d=await i(t.settingsApi,{method:"PATCH",body:JSON.stringify({api_key:c})});P(t,e,d.settings),n(d.message||`${l} stored.`,"success")}catch(d){console.error(`${l} save failed:`,d),n(d instanceof Error?d.message:`Failed to store ${l}.`,"error")}finally{t.isBusy=!1,o()}}async function gt(t,e,n,o,i,a,l){t.isBusy=!0,n(a,"info"),o();try{const c=await i(t.resetApi,{method:"POST"});P(t,e,c.settings),n(c.message||l,"success")}catch(c){console.error(`${l} failed:`,c),n(c instanceof Error?c.message:`Failed to clear ${l}.`,"error")}finally{t.isBusy=!1,o()}}function Cn(t){const e={hasKey:!1,isBusy:!1,last4:"",resetApi:"/api/settings/gemini/reset",settingsApi:"/api/settings/gemini"},n={hasKey:!1,isBusy:!1,last4:"",resetApi:"/api/settings/openai/reset",settingsApi:"/api/settings/openai"};function o(v){const y=v?.routes;e.settingsApi=y?.settings||"/api/settings/gemini",e.resetApi=y?.reset||"/api/settings/gemini/reset"}function i(v){const y=v?.routes;n.settingsApi=y?.settings||"/api/settings/openai",n.resetApi=y?.reset||"/api/settings/openai/reset"}function a(v){P(e,t.geminiApiKeyInput,v)}function l(){ut(e,t.geminiApiKeyInput,t.notifyGemini)}function c(v){P(n,t.openAiApiKeyInput,v)}function d(){ut(n,t.openAiApiKeyInput,t.notifyOpenAi)}async function f(){if(!t.isGeminiModuleActive()||e.isBusy||e.hasKey)return;if(!t.geminiApiKeyInput.value.trim()){t.notifyGemini("Gemini API key is required.","warning");return}await ht(e,t.geminiApiKeyInput,t.notifyGemini,t.updateButtons,t.fetchGeminiModuleJson,"Saving Gemini API key...","Gemini API key")}async function p(){!t.isGeminiModuleActive()||e.isBusy||await gt(e,t.geminiApiKeyInput,t.notifyGemini,t.updateButtons,t.fetchGeminiModuleJson,"Clearing Gemini API key...","Gemini API key cleared.")}async function k(){if(!t.isOpenAiModuleActive()||n.isBusy||n.hasKey)return;if(!t.openAiApiKeyInput.value.trim()){t.notifyOpenAi("OpenAI API key is required.","warning");return}await ht(n,t.openAiApiKeyInput,t.notifyOpenAi,t.updateButtons,t.fetchOpenAiModuleJson,"Saving OpenAI API key...","OpenAI API key")}async function S(){!t.isOpenAiModuleActive()||n.isBusy||await gt(n,t.openAiApiKeyInput,t.notifyOpenAi,t.updateButtons,t.fetchOpenAiModuleJson,"Clearing OpenAI API key...","OpenAI API key cleared.")}return{applyGeminiSettings:a,applyOpenAiSettings:c,clearGeminiKey:p,clearGeminiSettings:l,clearOpenAiKey:S,clearOpenAiSettings:d,getGeminiHasKey:()=>e.hasKey,getOpenAiHasKey:()=>n.hasKey,isGeminiBusy:()=>e.isBusy,isOpenAiBusy:()=>n.isBusy,saveGeminiKey:f,saveOpenAiKey:k,updateGeminiRoutes:o,updateOpenAiRoutes:i}}function xn(t){let e=!1,n=!1,o=!1,i=!1;async function a(){return t.fetchTimezoneListJson("/api/timezone/list")}function l(s){const h=s.settings,m=s.runtime;t.setSwitchChecked(t.clockModeToggle,!!h?.enabled),t.timezoneSelect.value=h?.timezone_name||"",t.clearFieldError(t.timezoneSelect),t.manualDateInput.value=typeof m?.current_date=="string"?m.current_date:"",t.manualTimeInput.value=typeof m?.current_time=="string"?m.current_time:""}function c(s){s&&(typeof s.clock_enabled=="boolean"&&t.setSwitchChecked(t.clockModeToggle,s.clock_enabled),t.manualDateInput.value=typeof s.current_date=="string"?s.current_date:"",t.manualTimeInput.value=typeof s.current_time=="string"?s.current_time:"")}async function d(){t.timezoneSelect.innerHTML="";const s=document.createElement("option");s.value="",s.textContent="Select timezone",t.timezoneSelect.appendChild(s);try{const h=await a(),m=Array.isArray(h.timezones)?h.timezones:[],x=t.buildTimezoneLabelMap(m);m.map(C=>({value:C.name,label:t.formatTimezoneLabel(C,x)})).sort((C,A)=>C.label.localeCompare(A.label)).forEach(C=>{const A=document.createElement("option");A.value=C.value,A.textContent=C.label,t.timezoneSelect.appendChild(A)})}catch(h){console.error("Timezone list fetch failed:",h),t.notify(h instanceof Error?h.message:"Failed to load timezones.","error")}}async function f(){if(!(e||n||o)){e=!0,n=!0,o=!0,t.onStateChange();try{const s=await t.fetchTimeSettingsJson(t.timeSettingsApi);l(s)}catch(s){console.error("Time settings status failed:",s),t.notify(s instanceof Error?s.message:"Time settings status failed.","error")}finally{e=!1,n=!1,o=!1,t.onStateChange()}}}async function p(){if(!(o||i)){i=!0;try{for(let s=0;s<t.clockSyncPollAttempts;s++){const h=await t.fetchTimeRuntimeJson(t.timeRuntimeApi);if(c(h.runtime),h.runtime?.time_valid===!0&&typeof h.runtime.current_time=="string"&&h.runtime.current_time.length>0)return;s<t.clockSyncPollAttempts-1&&await new Promise(m=>{setTimeout(m,t.clockSyncPollIntervalMs)})}}catch(s){console.error("Clock refresh after WiFi connect failed:",s)}finally{i=!1}}}async function k(){if(!(document.hidden||e||n||o)&&t.isSwitchChecked(t.clockModeToggle))try{const s=await t.fetchTimeRuntimeJson(t.timeRuntimeApi);c(s.runtime)}catch(s){console.error("Time runtime status failed:",s)}}function S(){const s=t.timezoneSelect.value.trim(),h=t.manualDateInput.value.trim(),m=t.manualTimeInput.value.trim(),x=t.parseClockTimeInputValue(t.wakeupTimeInput),C=t.parseClockTimeInputValue(t.bedtimeTimeInput);return!!h!=!!m?(t.notify("Provide both current date and time for a manual clock set.","error"),null):{timezoneName:s,manualDate:h,manualTime:m,wakeupMinutes:x??void 0,bedtimeMinutes:C??void 0}}async function v(s,h){return t.fetchTimeSettingsJson(t.timeSettingsApi,{method:"PATCH",body:JSON.stringify({timezone_name:s.timezoneName,enabled:h,manual_date:s.manualDate,manual_time:s.manualTime})})}async function y(){if(o||e||n){t.notifyClockMode("Clock mode update already in progress.","warning");return}const s=t.isSwitchChecked(t.clockModeToggle),h=!s,m=t.timezoneSelect.value.trim();t.setSwitchChecked(t.clockModeToggle,h),o=!0,t.notifyClockMode(h?"Enabling clock mode...":"Disabling clock mode...","info"),t.onStateChange();try{const x=await t.fetchTimeSettingsJson(t.timeSettingsApi,{method:"PATCH",body:JSON.stringify({enabled:h,timezone_name:h&&m?m:void 0})});l(x),t.notifyClockMode(x.message||(h?"Clock mode enabled.":"Clock mode disabled."),"success")}catch(x){t.setSwitchChecked(t.clockModeToggle,s),console.error("Clock mode toggle failed:",x);const C=x instanceof Error?x.message:"Failed to update clock mode.",A=C==="timezone_name required to enable clock"?"Please set timezone first.":C;C==="timezone_name required to enable clock"&&(t.setFieldError(t.timezoneSelect,"Select a timezone."),t.timezoneSelect.focus({preventScroll:!0})),t.notifyClockMode(A,"error")}finally{o=!1,t.onStateChange()}}async function T(){if(e||n||o||t.isTalkingClockModuleBusy()){t.notify("Time configuration update already in progress.","warning");return}const s=S();if(s){if(!s.timezoneName){t.setFieldError(t.timezoneSelect,"Select a timezone."),t.notify("Select a timezone.","error"),t.timezoneSelect.focus({preventScroll:!0});return}if(t.clearFieldError(t.timezoneSelect),t.isTalkingClockModuleActive()&&(s.wakeupMinutes===void 0||s.bedtimeMinutes===void 0)){t.notify("Wakeup and bedtime times are required for the talking clock module.","error"),t.focusTalkingClockTimeInput();return}e=!0,n=!0,o=!0,t.onTalkingClockBusyChange(t.isTalkingClockModuleActive()),t.notify("Saving time configuration...","info"),t.onStateChange();try{const h=await v(s,t.isSwitchChecked(t.clockModeToggle));if(l(h),t.isTalkingClockModuleActive()){const m=await t.patchTalkingClockSettings({wakeup_minutes:s.wakeupMinutes,bedtime_minutes:s.bedtimeMinutes});t.applyTalkingClockModuleSettings(m.settings)}t.notify("Time configuration saved successfully.","success")}catch(h){console.error("Timezone/location save failed:",h),t.notify(h instanceof Error?h.message:"Failed to save time configuration.","error")}finally{e=!1,n=!1,o=!1,t.onTalkingClockBusyChange(!1),t.onStateChange()}}}async function E(){if(e||n||o){t.notify("Time configuration update already in progress.","warning");return}e=!0,n=!0,o=!0,t.notify("Clearing timezone/location...","info"),t.onStateChange();try{const s=await t.fetchTimeSettingsJson(t.timeSettingsApi,{method:"PATCH",body:JSON.stringify({enabled:!1,timezone_name:""})});l(s),t.notify("Timezone/location cleared successfully.","success")}catch(s){console.error("Timezone/location clear failed:",s),t.notify(s instanceof Error?s.message:"Failed to clear timezone/location.","error")}finally{e=!1,n=!1,o=!1,t.onStateChange()}}return{applyTimeRuntimeStatus:c,applyTimeSettingsStatus:l,clearTimezoneLocation:E,fetchTimeRuntimeStatus:k,fetchTimeSettingsStatus:f,isClockBusy:()=>o,isLocationBusy:()=>n,isTimezoneBusy:()=>e,populateTimezoneOptions:d,refreshClockStatusAfterWifiConnect:p,saveTimezoneLocation:T,toggleClockModeSetting:y}}function Sn(t,e){return t>=-50?e.fourBar:t>=-60?e.threeBar:t>=-70?e.twoBar:e.oneBar}function Tn(t){let e=[],n="",o=!1,i="",a=!1,l=!1,c=!1,d=-1;function f(){t.wifiStatusCard.hidden=!1,t.wifiStatusCard.statusLabel=o?"Connected":"Disconnected",t.wifiStatusCard.network=o?i:""}function p(){const r=document.createElement("li");r.className="networks__list-empty-state",r.innerHTML=`${t.svgWithClass(t.wifiFindIcon,"wifi-find-icon")}<p>Scan for available networks</p>`,t.networkList.setEmptyState(r)}function k(){if(e.length===0){n="",d=-1;return}const r=e.findIndex(u=>u.ssid===n);if(r>=0){d=r;return}n="",d=-1}function S(){const r=t.networkList.getOptions();r.forEach((u,g)=>{u.setAttribute("aria-selected",String(n===e[g]?.ssid))}),d>=0&&d<r.length?t.networkList.setActiveDescendant(r[d].id):t.networkList.setActiveDescendant(null)}function v(){const r=e.find(u=>u.ssid===n);return r?!r.is_open:!0}function y(r){n=r,d=e.findIndex(u=>u.ssid===r),v()||t.clearFieldError(t.passwordInput),S(),t.onStateChange()}function T(){if(k(),t.networkList.clearItems(),e.length===0){p();return}e.forEach((r,u)=>{const g=document.createElement("li");g.className="networks__item",g.id=`network-option-${u}`,g.setAttribute("role","option"),g.setAttribute("tabindex","-1"),g.setAttribute("aria-selected",String(n===r.ssid));const O=document.createElement("span");O.className="networks__item-ssid",O.textContent=r.ssid;const I=document.createElement("div");if(I.className="networks__item-details",i===r.ssid&&o){const D=document.createElement("span");D.title="Currently connected",D.innerHTML=t.svgWithClass(t.checkIcon,"wifi-connected-icon"),I.appendChild(D)}const N=document.createElement("span");N.title=r.is_open?"Open":"Secured",r.is_open||(N.innerHTML=t.svgWithClass(t.securityIcon,"wifi-security-icon")),I.appendChild(N);const V=document.createElement("span");V.title=`Signal strength: ${r.signal_strength} (${r.rssi} dBm)`,V.innerHTML=t.svgWithClass(Sn(r.rssi,t.signalIcons),"wifi-signal-icon"),I.appendChild(V),g.append(O,I),g.addEventListener("click",()=>{d=u,y(r.ssid),t.networkList.focus({preventScroll:!0})}),t.networkList.appendItem(g)}),S()}function E(r){const u=o,g=i;o=r.connected===!0,i=typeof r.ssid=="string"?r.ssid:"",f(),(u!==o||g!==i)&&T(),t.onConnectionStateChange?.({wasConnected:u,previousNetwork:g,isCurrentlyConnected:o,connectedNetwork:i})}async function s(){if(!a){a=!0,t.notify("Scanning for networks...","info"),t.onStateChange();try{let r="Scanning for networks...";for(let u=0;u<t.scanPollAttempts;u++){const g=await t.fetchPortalJson("/api/scan");if(r=g.message||r,g.scan_in_progress===!0){if(t.notify(r,"info"),u<t.scanPollAttempts-1){await t.delayMs(t.scanPollIntervalMs);continue}}else{e=Array.isArray(g.networks)?g.networks:[],t.notify(r||"Scan complete.","success"),T();return}}throw new Error("Network scan timed out. Please try again.")}catch(r){console.error("Scan failed:",r),t.notify(r instanceof Error?r.message:"Scan failed. Please try again.","error"),e=[],T()}finally{a=!1,t.onStateChange()}}}async function h(){if(!l){l=!0,t.onStateChange();try{const r=await t.fetchPortalJson("/api/status");E(r),a||t.notify(r.message||"Status updated.",r.connected?"success":"info")}catch(r){console.error("Status check failed:",r),t.notify(r instanceof Error?r.message:"Status check failed.","error")}finally{l=!1,t.onStateChange()}}}async function m(){if(!(c||!n)){if(v()&&t.passwordInput.value.trim().length===0){t.setFieldError(t.passwordInput,"Please enter a WiFi password."),t.passwordInput.focus({preventScroll:!0});return}if(t.passwordInput.value.length>ct){t.setFieldError(t.passwordInput,`WiFi password must be ${ct} characters or fewer.`),t.passwordInput.focus({preventScroll:!0});return}t.clearFieldError(t.passwordInput),c=!0,t.notify(`Connecting to ${n}...`,"info"),t.onStateChange();try{const r=await t.fetchPortalJson("/api/configure",{method:"POST",body:JSON.stringify({ssid:n,password:t.passwordInput.value})});t.notify(r.message||"Connection request sent.","info");for(let u=0;u<t.statusPollAttempts;u++){await t.delayMs(t.statusPollIntervalMs);const g=await t.fetchPortalJson("/api/status");if(E(g),g.connected){t.notify(g.message||"Connected.","success");break}}o||t.notify("Connection in progress...","info")}catch(r){console.error("Connection failed:",r),t.notify(r instanceof Error?r.message:"Connection failed.","error")}finally{c=!1,t.onStateChange()}}}async function x(){if(!(c||l||!o)){l=!0,t.notify("Disconnecting...","info"),t.onStateChange();try{const r=await t.fetchPortalJson("/api/disconnect",{method:"POST"}),u=o,g=i;o=!1,i="",f(),T(),t.notify(r.message||"Disconnected.","success"),t.onConnectionStateChange?.({wasConnected:u,previousNetwork:g,isCurrentlyConnected:o,connectedNetwork:i})}catch(r){console.error("Disconnect failed:",r),t.notify(r instanceof Error?r.message:"Disconnect failed.","error")}finally{l=!1,t.onStateChange()}}}function C(){if(it()){x();return}if(c||l){t.notify("WiFi status is busy. Please wait.","warning");return}if(!n){t.notify("Select a WiFi network first.","error"),t.networkList.focus({preventScroll:!0});return}if(v()&&t.passwordInput.value.trim().length===0){t.setFieldError(t.passwordInput,"Please enter a WiFi password."),t.notify("Please check if your password is correct.","error"),t.passwordInput.focus({preventScroll:!0});return}t.clearFieldError(t.passwordInput),m()}function A(){t.passwordInput.value?.trim().length&&t.clearFieldError(t.passwordInput),t.onStateChange()}function Ot(r){if(e.length!==0)switch(k(),r.key){case"Tab":break;case"ArrowDown":{r.preventDefault();const u=d<e.length-1?d+1:0;d=u,y(e[u].ssid),t.networkList.scrollOptionIntoView(u);break}case"ArrowUp":{r.preventDefault();const u=d>0?d-1:e.length-1;d=u,y(e[u].ssid),t.networkList.scrollOptionIntoView(u);break}case"Home":{r.preventDefault(),d=0,y(e[0].ssid),t.networkList.scrollOptionIntoView(0);break}case"End":{r.preventDefault();const u=e.length-1;d=u,y(e[u].ssid),t.networkList.scrollOptionIntoView(u);break}case"Enter":case" ":{r.preventDefault(),d>=0&&d<e.length&&y(e[d].ssid);break}}}function it(){return o&&i.length>0&&n===i}return{applyPortalStatus:E,checkStatus:h,connect:m,disconnect:x,getConnectedNetwork:()=>i,getSelectedNetwork:()=>n,handleConnectAction:C,handleListboxKeyDown:Ot,handlePasswordInput:A,isCheckingStatus:()=>l,isConnecting:()=>c,isCurrentlyConnected:()=>o,isScanning:()=>a,isSelectedConnected:it,renderNetworkList:T,requiresPassword:v,scanNetworks:s,updateWifiStatusCard:f}}function z(t,e){e().finally(()=>{!t.disabled&&t.offsetParent!==null&&setTimeout(()=>{!t.disabled&&t.offsetParent!==null&&t.focus()},0)})}function kn(t){const{controllers:e,dom:n,helpers:o}=t;function i(){n.wifiSettingsSheet.openBottomSheet(),e.wifiController.scanNetworks()}n.scanBtn.addEventListener("click",()=>{e.wifiController.scanNetworks()}),n.connectBtn.addEventListener("click",()=>{e.wifiController.handleConnectAction()}),n.wifiStatusCard.addEventListener("action",()=>{if(e.wifiController.isCurrentlyConnected()){e.wifiController.disconnect();return}i()}),n.wifiStatusCard.addEventListener("settings",()=>{i()}),n.wifiSettingsCloseBtn.addEventListener("click",()=>{n.wifiSettingsSheet.closeBottomSheet()}),n.passwordInput.addEventListener("input",()=>{e.wifiController.handlePasswordInput()}),n.networkList.addEventListener("keydown",a=>{e.wifiController.handleListboxKeyDown(a)}),n.geminiSaveBtn.addEventListener("click",()=>{z(n.geminiSaveBtn,()=>e.geminiController.saveGeminiKey())}),n.geminiClearBtn.addEventListener("click",()=>{z(n.geminiClearBtn,()=>e.geminiController.clearGeminiKey())}),n.geminiApiKeyInput.addEventListener("input",o.updateUi),n.timezoneLocationSaveBtn.addEventListener("click",()=>{if(!n.timezoneSelect.value.trim()){o.setFieldError(n.timezoneSelect,"Select a timezone."),o.setTimezoneLocationNotification("Select a timezone.","error"),n.timezoneSelect.focus({preventScroll:!0});return}o.clearFieldError(n.timezoneSelect),z(n.timezoneLocationSaveBtn,()=>e.timeController.saveTimezoneLocation())}),n.timezoneLocationClearBtn.addEventListener("click",()=>{z(n.timezoneLocationClearBtn,()=>e.timeController.clearTimezoneLocation())}),n.timezoneSelect.addEventListener("change",()=>{n.timezoneSelect.value?.trim().length&&o.clearFieldError(n.timezoneSelect),o.updateUi()}),n.manualDateInput.addEventListener("input",o.updateUi),n.manualTimeInput.addEventListener("input",o.updateUi)}function An(t){const{controllers:e,dom:n}=t,o=e.wifiController.isScanning()||e.wifiController.isConnecting()||e.wifiController.isCheckingStatus(),i=e.wifiController.isSelectedConnected(),a=e.wifiController.getSelectedNetwork().trim(),l=a.length>0&&!i&&e.wifiController.requiresPassword(),c=i||a.length>0&&(!l||n.passwordInput.value.trim().length>0);n.scanBtn.disabled=o,n.connectBtn.disabled=o||!c,n.wifiStatusCard.actionDisabled=o,n.passwordInput.disabled=e.wifiController.isConnecting(),e.wifiController.isConnecting()?(n.connectBtn.textContent="Connecting...",n.wifiStatusCard.actionLabel="Connecting..."):i?(n.connectBtn.textContent="Disconnect",n.wifiStatusCard.actionLabel="Disconnect"):(n.connectBtn.textContent="Connect",n.wifiStatusCard.actionLabel=e.wifiController.isCurrentlyConnected()?"Disconnect":"Connect");const d=e.timeController.isTimezoneBusy()||e.timeController.isLocationBusy()||e.timeController.isClockBusy();n.timezoneSelect.disabled=d,n.manualDateInput.disabled=d,n.manualTimeInput.disabled=d,n.timezoneLocationSaveBtn.disabled=d||n.timezoneSelect.value.trim().length===0,n.timezoneLocationClearBtn.disabled=d||n.timezoneSelect.value.trim().length===0;const f=e.geminiController.isGeminiBusy(),p=e.geminiController.getGeminiHasKey();n.geminiApiKeyInput.readOnly=p||f,n.geminiApiKeyInput.disabled=f,n.geminiSaveBtn.disabled=f||p||n.geminiApiKeyInput.value.trim().length===0,n.geminiSaveBtn.hidden=p,n.geminiClearBtn.disabled=f||!p,n.geminiClearBtn.hidden=!p}jt();Gt();te();ae();me();ve();xe();_e();qe();let Q=null;const w=cn(),zt=dn(w.wifiSettingsNotification),En=It(w.geminiCard),qt=It(w.timezoneLocationCard),Pt=()=>document.createElement("input"),_n=document.createElement("button"),Ln=Pt(),In=Pt(),Mn=document.createElement("input");function _(){An({controllers:{geminiController:nt,timeController:L,wifiController:M},dom:w})}const nt=Cn({fetchGeminiModuleJson:Lt,fetchOpenAiModuleJson:()=>Promise.resolve({}),geminiApiKeyInput:w.geminiApiKeyInput,isGeminiModuleActive:()=>!0,isOpenAiModuleActive:()=>!1,notifyGemini:En,notifyOpenAi:()=>{},openAiApiKeyInput:Mn,updateButtons:_}),L=xn({applyTalkingClockModuleSettings:()=>{},bedtimeTimeInput:In,clearFieldError:tt,clockModeToggle:_n,clockSyncPollAttempts:je,clockSyncPollIntervalMs:Je,fetchTimeRuntimeJson:an,fetchTimeSettingsJson:sn,fetchTimezoneListJson:ln,focusTalkingClockTimeInput:()=>{},buildTimezoneLabelMap:vn,formatTimezoneLabel:yn,isSwitchChecked:hn,isTalkingClockModuleActive:()=>!1,isTalkingClockModuleBusy:()=>!1,manualDateInput:w.manualDateInput,manualTimeInput:w.manualTimeInput,notifyClockMode:()=>{},notify:qt,onStateChange:_,onTalkingClockBusyChange:()=>{},parseClockTimeInputValue:wn,patchTalkingClockSettings:()=>Promise.resolve({success:!0}),setFieldError:et,setSwitchChecked:un,timeRuntimeApi:nn,timeSettingsApi:en,timezoneSelect:w.timezoneSelect,wakeupTimeInput:Ln}),M=Tn({checkIcon:Re,clearFieldError:tt,delayMs:fn,fetchPortalJson:rn,networkList:w.networkList,notify:zt,onConnectionStateChange:({wasConnected:t,isCurrentlyConnected:e})=>{!t&&e&&L.refreshClockStatusAfterWifiConnect()},onStateChange:_,passwordInput:w.passwordInput,scanPollAttempts:Qe,scanPollIntervalMs:Xe,securityIcon:Ne,setFieldError:et,signalIcons:{oneBar:Ve,twoBar:De,threeBar:He,fourBar:$e},statusPollAttempts:We,statusPollIntervalMs:Ue,svgWithClass:Mt,wifiFindIcon:Ke,wifiStatusCard:w.wifiStatusCard});function q(){if(!Q)return;const t=document.documentElement,e=t.scrollHeight>window.innerHeight+1,n=window.scrollY+window.innerHeight>=t.scrollHeight-1;Q.setVisible(e&&!n)}function Bn(){gn(w.followupLogoEl,Pe,"followup-logo"),w.wifiStatusCard.iconSvg=Oe,w.geminiCard.iconSvg=Fe,w.timezoneLocationCard.iconSvg=Ge,M.renderNetworkList(),document.body&&(Q=Ht({mount:document.body,mode:"fixed",position:"bottom",height:"6rem",width:"100vw",strength:1.8,divCount:5,curve:"bezier",exponential:!0,opacity:1,zIndex:20,className:"page-gradual-blur",fallbackColor:"var(--color-bg-selected)"}),q(),window.addEventListener("scroll",q,{passive:!0}),window.addEventListener("resize",q),typeof ResizeObserver<"u"&&new ResizeObserver(()=>{q()}).observe(document.body)),_(),M.updateWifiStatusCard(),zt(""),kn({controllers:{geminiController:nt,timeController:L,wifiController:M},dom:w,helpers:{clearFieldError:tt,setFieldError:et,setTimezoneLocationNotification:qt,updateUi:_}}),zn(),window.setInterval(()=>{L.fetchTimeRuntimeStatus()},Ye)}async function zn(){await Promise.allSettled([L.populateTimezoneOptions(),L.fetchTimeSettingsStatus(),M.checkStatus(),qn()])}async function qn(){try{const t=await Lt("/api/settings/gemini");nt.applyGeminiSettings(t.settings)}catch(t){console.error("Gemini settings status failed:",t)}finally{_()}}Bn();
